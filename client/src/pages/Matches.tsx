...
export default function Matches() {
  ...
  const rounds = ["All", "Preliminary", "Quarter Final", "Semi Final", "Final"];
            ...
            <>
              ...
              {filteredMatches.length === 0 ? (
                ...
                <div className="max-w-5xl mx-auto relative px-1 sm:px-0">
                  {/* Timeline Line */}
                  <div className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-blue-500 to-purple-500 transform -translate-x-1/2" />
                  ...
                  <div className="space-y-8 sm:space-y-12">
                    {filteredMatches.map((match, index) => {
                      ...
                      >
                        {/* Timeline Icon */}
                        <div className="absolute left-1/2 transform -translate-x-1/2 w-10 h-10 sm:w-16 sm:h-16 rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(255,215,0,0.6)] z-10 border-4 border-black bg-black">
                          {match.game.icon ? (
                            <img 
                              src={match.game.icon} 
                              alt={match.game.name}
                        ...
                        {/* Match Card */}
                        <div className={`w-[calc(50%-1.25rem)] sm:w-[calc(50%-4rem)] ${
                          isLeft ? 'text-right' : 'text-left'
                        }`}>
                          <div
                            className="bg-black/60 backdrop-blur-xl border border-white/20 rounded-xl sm:rounded-2xl overflow-hidden shadow-xl hover:border-primary/50 transition-all group hover:scale-[1.02] hover:-translate-y-1"
                          >
                            {/* Match Header */}
                            ...
                            <div className="p-2 sm:p-6">
                              ...
                              <div className="space-y-2 sm:space-y-4 mb-3 sm:mb-6">
                                ...
                                <div className="flex flex-col items-center gap-1 sm:gap-2">
                                  <div className="text-white font-bold text-[11px] sm:text-lg text-center leading-tight">{match.teamA.hallId.name}</div>
                                  <div className="text-primary text-[10px] sm:text-sm">Team {match.teamA.teamName}</div>
                                </div>
                                ...
                                {/* Team B */}
                                <div className="flex flex-col items-center gap-1 sm:gap-2">
                                  <div className="text-white font-bold text-[11px] sm:text-lg text-center leading-tight">{match.teamB.hallId.name}</div>
                                  <div className="text-primary text-[10px] sm:text-sm">Team {match.teamB.teamName}</div>
                                </div>
                              </div>
